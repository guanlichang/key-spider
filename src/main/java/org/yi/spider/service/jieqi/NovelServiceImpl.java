...
public class NovelServiceImpl extends BaseService implements INovelService {
    ...
    private final class NovelEntityResutlSetHandler implements ResultSetHandler<NovelEntity> {
        @Override
    ...
    protected User loadAdmin() throws SQLException {
        ...
        return queryRunner.query(conn, "SELECT uid, uname FROM jieqi_system_users ORDER BY uid LIMIT 0,1",
    ...
    public NovelEntity find(String novelName) throws SQLException {
        ...
        String sql = "select articleid,articlename,author,sortid,typeid,intro" + ziduan
                + " from jieqi_article_article where articlename=?";
